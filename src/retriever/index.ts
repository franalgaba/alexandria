...
export class Retriever {
   ...
   */
  async compilePack(options: PackOptions = {}): Promise<ContextPack> {
   ...
   */
  compileMinimalPack(): ContextPack {
...
export { extractScope, scoreScopeMatch, codeRefsMatchScope } from './scope.ts';
